...
img_task = Task(
    steps=[(fn.copy_files, {"out_dir": "./dist", "relative_to": "./src"})],
    name="copy images",
    change_types="change",
...
bb_js_task = Task(
    steps=[
        (
            fn.copy_files,
            {
                "__filepath": "./src/ext/baguetteBox.js/dist/baguetteBox.min.js",
                "out_dir": "./dist/js",
                "relative_to": "./src/ext/baguetteBox.js/dist",
            },
        )
    ],
    name="copy baguettebox js",
)
